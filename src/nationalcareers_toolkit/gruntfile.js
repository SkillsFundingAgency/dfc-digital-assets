...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        copy: {
            dist: {
                files: [
                    { expand: true, cwd: 'node_modules/govuk-frontend/dist/govuk/assets/fonts', src: '**', dest: '<%= dist.path %>/fonts/' },
                    { expand: true, cwd: 'node_modules/govuk-frontend/dist/govuk/assets/images', src: ['**/*.{png,jpg,gif,jpeg,svg,ico}', '!fonts/*', '!sprite/*.*'], dest: '<%= dist.path %>/images' },
